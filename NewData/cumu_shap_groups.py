...
sig_csv = "NewData/Correlation_Matrices/Signal_CorrelationMatrix.csv"
bkg_csv = "NewData/Correlation_Matrices/Background_CorrelationMatrix.csv"
...
variable_list = ["bVtxCL", "kstTMass", "kstPt", "kstTrkmPt", "kstTrkmDCABS", "kstTrkpPt", "kstTrkpDCABS", 
...
dir_path = "NewData/ROOT_files"
X, y = prepdata(dir_path, "signal.root", "background.root", variable_list)
...
# ------------- Save outputs -------------
OUT_DIR = "NewData/Cumulative_SHAP_Grouped"
