...
def main():
    try:
        dir = "/user/u/u25teresaesc/Internship/Signal vs Background"
        file = "comparison.root"

        x, y = prepdata(dir, file)
        ...
        # Save models
        checkpoint_dir = "/user/u/u25teresaesc/Internship/Machine Learning/Evaluation"
